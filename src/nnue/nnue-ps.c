...
const uint32_t nnueFileHeaderVersion=0x246977F7; // randomly generated - hopefully it doesn't clash with anything out in the wild
...
bool nnueNetSave(const NnueNet *net, const char *path) {
	...
	// Write header
	const char *desc="Simple Piece-Square feature set with a single hidden layer: 768->64*2->16->1.";
